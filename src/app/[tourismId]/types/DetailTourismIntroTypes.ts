export type DetailTourismIntro = {
  // 공통 타입 정의
  contentid: string;
  ...
  heritage2?: string; // 세계문화유산유무
  heritage3?: string; // 세계문화유산유무
  ...
  infocenterculture?: string; // 문의및안내
  ...
  infocentertourcourse?: string; // 문의및안내
  ...
  infocenterlodging?: string; // 문의및안내
...
export type DetailTourismIntroApiResponse = {
  response: {
    body: {
      items: {
        item: DetailTourismIntro[];
      };
    };
    numOfRows: number;
    pageNo: number;
