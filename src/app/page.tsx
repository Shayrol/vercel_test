...
// 06/23
// 승인이 아직 안나와서 연습용으로 했던 즉 로컬에서만 동작하는 Map 구현해 놓음
// 배포를 했지만 에러로 맵은 가져오지 못하고 있음
//
// 한것:
// 카카오 맵 추가

// 06/24
// 이전 카카오 맵 작업했던 애플리케이션이 있어 우선 해당 map을 사용해 띄움
// vercel의 환경 변수 추가
// header의 반응형으로 모바일 환경 뒤로가기 기능 먼저 구현 - 세션스토리지에 저장을 해 쿼리스트링 포함 저장
